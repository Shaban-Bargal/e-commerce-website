...
const ProductCard = ({ product }) => {
    ...
    return product && (
        <div onClick={() => { navigate(`/products/${product.category.toLowerCase()}/${product._id}`); scrollTo(0, 0) }} className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-32 max-w-56 w-full">
                    ...
                    <div onClick={(e) => { e.stopPropagation() }} className="text-primary">
                        ...
                        {!cartItems?.[product._id] ? (
                            ...
                            <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-primary/10 rounded select-none">
                                ...
                                {/* تعديل هنا: إضافة الـ ? وقيمة افتراضية 0 */}
