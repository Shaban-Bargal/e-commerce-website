            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {User && (
                    <div className='relative group z-30'>
                        ...
                        <ul className='absolute hidden group-hover:block top-10 w-[110px] right-0 gap-4 bg-white border border-gray-300 px-3 py-2 text-[15px]'>
                            <li onClick={() => navigate("my-orders")} className='p-1 cursor-pointer'>My Orders</li>
                            <li onClick={logout} className='p-1 cursor-pointer'>Logout</li>
                        </ul>
                    </div>
                )}
            </div>
